...
sf data bulk upsert -s trailheadapp__Trail__c -f ./test-data/trails.csv -i trailheadapp__External_Id__c -w 10
sf data bulk upsert -s trailheadapp__Badge__c -f ./test-data/badges.csv -i trailheadapp__External_Id__c -w 10
